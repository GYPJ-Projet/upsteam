...
?>
    ...
    <div data-js-component="GestionCouleur" data-js-controleur-action="gestionCouleur">
        <a class="bouton" href="index.php?GestionDonnees&action=afficherFormulaireCouleur&page=<?= $pageCourante ?>" data-js-ajouter><?= $langue["button_ajouter"] ?></a>
        <table class="table">
            <thead>
                <tr>
                    <th>
...
?>         
                <tr>
                    ...
                    <td><?= ($couleur->getDisponibilite() == true)? $langue["texte_oui"] : "" ?></td>
                    <td><a href="index.php?GestionDonnees&action=afficherFormulaireCouleur&id=<?= $couleur->getId() ?>&page=<?= $pageCourante ?>" data-js-modifier data-js-id=<?= $couleur->getId() ?>><?= $langue["button_modifier"] ?></a></td>
                    
                    <!-- <td><a href="index.php" data-js-modifier data-js-id=<?= $couleur->getId() ?>><?= $langue["button_modifier"] ?></a></td> -->
                </tr>   
<?php       
    }   
?>
