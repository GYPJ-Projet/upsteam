    ...
    <div class="formulaireConnexion" data-js-controleur="Usager"  data-js-controleur-action="connexion"> 
        ...
        <form class="formulaireConnexionform" action="index.php?Usager" method="post">
            ...
            <div class="formulaireConnexionInput">
                ...
                <input class="formulaireConnexionInput" size="30" type="text" name="courriel" placeholder="<?= $langue['tempCourriel'] ?>"/><br>
            </div>

            <div class="formulaireConnexionInput">
                <label for="motPasse"> <?= $langue['motPasse'] ?> </label> 
                <input class="formulaireConnexionInput" size="30" type="password" name="motPasse" placeholder="<?= $langue['tempMotPasse'] ?>" /><br>
            </div>
        ...
        <input class="boutonFormCreerCompte sourisPointer" type="button" value="<?= $langue['creerCompte'] ?>" data-js-btnCreerCompte/>
    </div>
</section>
<?php
